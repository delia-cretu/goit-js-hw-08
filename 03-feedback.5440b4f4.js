...
form.addEventListener("input", (0, _lodashThrottleDefault.default)(storeObject, 500));
...
document.addEventListener("submit", (0, _lodashThrottleDefault.default)(submitForm, 500));
function submitForm(event) {
    console.log("Before form clearing:\nEmail: " + data.email + "\n" + "Message: " + data.message);
    ...
    console.log("After form clearing:\nEmail: " + data.email + "\n" + "Message: " + data.message);
}
